...
System performance visualization in form of time-series is available both in example notebooks and through the GUI, either spined off locally or [using a web deployed version](https://solar.floweragenda.org/).
