...
sys.path.insert(0, os.path.abspath("../mswh"))
...
latex_documents = [
    (
        master_doc,
        "MSWH.tex",
        u"Multiscale Solar Water Heating - Code Documentation",
        u"Milica Grahovac \\\\ Katie Coughlin \\\\ Mohan Ganeshalingam \\\\ Hannes Gerhart \\\\ Robert Hosbach \\\\ Vagelis Vossos",
        "manual",
        True,
    ),
]
