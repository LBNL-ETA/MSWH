class SwhLabels(object):
    ...
    def set_prod_labels(self):
        ...
        self.sys_l = {
            ...
            'pipe_spec_hea_con': \
                'piping insulation specific heat conductivity',
    ...
    def set_res_labels(self):
        ...
        self.res_l = {
            ...
            'gas_use_w_no_dist': \
                'Energy Use - Gas, Winter, w/o Dist Loss',
            ...
            'gas_sav_s_no_dist': \
                'Energy Savings - Gas, Summer, w/o Dist Loss',
            'gas_sav_w_no_dist': \
                'Energy Savings - Gas, Winter, w/o Dist Loss',
            ...
            'q_dist_loss_at_bckp_sum': \
                'Distribution Heat Loss at Backup, Summer',
            'q_dist_loss_at_bckp_win': \
