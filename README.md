...
[docs](docs) | API documentation, including a short methodology documentation can be found [here](https://github.com/LBNL-ETA/MSWH/blob/v2.0.0/docs/MSWH.pdf). To build HTML or LaTeX use `make html` or `make latex`. A `pdf` version of the Code Documentation can be viewed and downloaded [here](https://github.com/LBNL-ETA/MSWH/blob/v2.0.0/docs/MSWH.pdf).
